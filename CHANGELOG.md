...
- Phase 4G UI documentation retrofit, continued: Traffic Controls' Policy, IP Rules, and Blocks tabs gained explainer paragraphs matching the voice established on Settings/Overview (v2.9.67) and the CSP Dashboard (v2.9.69). The Network Intelligence, Detectors, and Custom Rules tabs on this same page already had this level of detail, written when those features originally shipped (v2.9.66/v2.9.74) -- this closes the remaining gap on the page.
