...
- the SAM Portal is live and GitHub #174's grace-period requirement is closed with working code, not just schema (tracked in `.roadmap/sam_portal_plan.md`), and no Stripe secret exists on any customer WordPress install;
