...
**Status: Admin-UI retrofit fully delivered (v2.9.67-v2.9.96, 4-10 September 2026). Remaining: the GitHub Pages help site's `user-guide.html`/`faq.html`, and the guided onboarding/getting-started flow (not yet started).**
...
**Admin-UI retrofit: complete.** Remaining for this phase:
- The GitHub Pages help site's `docs/user-guide.html` and `docs/faq.html` (assessed 2026-09-04, not yet written -- see above).
- The guided onboarding/getting-started flow (deliberately sequenced after the admin-UI retrofit) -- no design work done yet.
