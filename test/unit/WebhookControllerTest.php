 ...
 *
 * WP_REST_Request and WP_REST_Response are stubbed centrally in
 * bootstrap.php (loaded before any test file, so this file no longer needs
 * -- or defines -- its own copies; see GitHub issue #164).
 */
